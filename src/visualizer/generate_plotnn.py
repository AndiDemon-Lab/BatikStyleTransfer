...
def generate_vgg16():
    ...
    arch = [
        ...
        ToPool(
            "pool1", offset="(0,0,0)", to="(conv1_2-east)", height=35, depth=35, width=1
        ),
        ...
        ToPool(
            "pool2", offset="(0,0,0)", to="(conv2_2-east)", height=30, depth=30, width=1
        ),
        ...
        ToPool(
            "pool3", offset="(0,0,0)", to="(conv3_3-east)", height=25, depth=25, width=1
        ),
        ...
        ToPool(
            "pool4", offset="(0,0,0)", to="(conv4_3-east)", height=20, depth=20, width=1
        ),
...
def generate_vgg19():
    ...
    arch = [
        ...
        ToPool(
            "pool3", offset="(0,0,0)", to="(conv3_4-east)", height=25, depth=25, width=1
        ),
        ...
        ToPool(
            "pool4", offset="(0,0,0)", to="(conv4_4-east)", height=20, depth=20, width=1
        ),
...
def generate_resnet50():
    ...
    arch = [
        ...
        ToPool(
            "pool1", offset="(0,0,0)", to="(conv1-east)", height=35, depth=35, width=1
        ),
